...
function Write-Theme {
    ...
    # write # and space
    $prompt = Write-Prompt -Object $sl.PromptSymbols.StartSymbol -ForegroundColor $sl.Colors.PromptSymbolsColor
    # write user
    # $user = $sl.CurrentUser
    $user = "aki"
    if (Test-NotDefaultUser($user)) {
        ...
        $computer = "MISAKA-NETWORK"
        $prompt += Write-Prompt -Object " @" -ForegroundColor $sl.Colors.PromptForegroundColor
        $prompt += Write-Prompt -Object " $computer" -ForegroundColor $sl.Colors.AdminIconForegroundColor
        # write in for folder
    ...
    $foregroundColor = $sl.Colors.ForegroundColor
...
$sl.Colors.ForegroundColor = [ConsoleColor]::Red
$sl.Colors.PromptSymbolsColor = [ConsoleColor]::Blue
$sl.Colors.ComputerColor = [ConsoleColor]::DarkYellow
